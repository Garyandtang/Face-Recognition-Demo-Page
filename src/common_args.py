...
def get_args():
    ...
    parser.add_argument('--iterations', default=4000, type=int, help='number of training epochs')
    ...
    parser.add_argument('--downsampling_factor', default=7, type=int, help='downsampling factor')
