...
if __name__ == '__main__':
    ...
    lr_alexnet.load_state_dict(torch.load('/home/tangjiawei/PycharmProjects/RadimoicDeepFeatureExtraction/model/1000_lr_alexnet_df9.pth')) #model_root_lr is Alexnet prtrained in with feature loss
